...
class TestCalliope(unittest.TestCase):
    ...
    def test_battery_should_be_serviced(self):
        ...
        factory = CarFactory()
        car = factory.buildCalliope(last_service_date, current_mileage, last_service_mileage)
        self.assertTrue(car.need_service())

    def test_battery_should_not_be_serviced(self):
        today = datetime.today().date()
        last_service_date = today.replace(year=today.year - 1).strftime("%Y-%m-%d")
        current_mileage = 1
    ...
    def test_engine_should_be_serviced(self):
        last_service_date = datetime.today().date().strftime("%Y-%m-%d")
